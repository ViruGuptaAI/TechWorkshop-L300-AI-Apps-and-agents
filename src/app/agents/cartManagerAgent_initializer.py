...
CART_PROMPT_TARGET = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'prompts', 'CartManagerPrompt.txt')
with open(CART_PROMPT_TARGET, 'r', encoding='utf-8') as file:
    CART_PROMPT = file.read()
...
initialize_agent(
    ...
    name="Cart Manager - Zava Shopping Assistant",
    instructions=CART_PROMPT,
    toolset=toolset
)
